...
<script type="text/javascript" language="javascript" src="<?php echo erLhcoreClassDesign::designJS('vendor/jquery/jquery.min.js;js/modernizr.js;js/lh.js;js/jquery.hotkeys-0.7.9.min.js');?>"></script>